    ...
    Tpl = (e, i) => {
        ...
        if (e.src) {
           if(e.ago && e.price){
            ...
            <Image padding={0} src={e.src} {...this.imgProps} {...this.props.imgProps} onTap={() => { this.continue(e.target || (this.props.continue=="dialog"?i: this.props.continue + "?"+this.props.itemName+"=" + e.id)) }} height={this.props.height} style={{maxHeight:(this.props.height)+"px"}} />
