...
<Container   shadow={!Ext.platformTags.phone}    width="100%"  cls={Ext.platformTags.phone?"":"x-round"} style={{backgroundColor:Ext.platformTags.phone?"":"#ffffff",padding:"0"}}>
  <Container cls="mytitle" style={{color:"#ffffff",backgroundColor:"#6dcff6", margin:Ext.platformTags.phone?"10px":"10px 30px",textAlign:"center",width:Ext.platformTags.phone? "calc(100% - 20px)":"300px"}} docked="top"  >{ " تکمیل اطلاعات حساب کاربری سامانه"}</Container>
<Container scrollable layout={Ext.platformTags.phone?"vbox":"hbox"} padding="40 30" >
...
<SelectField ref="_bank" picker={"floated"}{...this.TProps} label="نام بانک"  value={user_info._bank} options={banks_options} onChange={(a, b, c) => { 
  ...
  <TextField  dir="rtl" ref="shaba" validateOnInit="all"  {...this.TProps2} label="شماره شبا" maxLength={26} value={user_info.shaba} textAlign="left"  validateOnInit="all" inputMask= 'IR000000000000000000000000'/>
    ...
    text="تایید و ادامه " width={Ext.platformTags.phone?"100%":"210"}  docked="bottom"  handler={()=>{
...
<Image width="100%" src={colorfooter}  height="10px" docked="bottom" mode="img" hidden={Ext.platformTags.phone}/>
...
<Container margin="0" >
        <Image src={footer_title} mode='img' />
        <Image width="100%" src={colorfooter}  height="10px" mode="img" hidden={!Ext.platformTags.phone}/>
