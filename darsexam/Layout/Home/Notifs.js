...
console.log(this.state)
    ...
    "راهنمای آزمون"}</h2></Container><Container hidden={Ext.platformTags.phone} style={{color:"#898989",fontSize:"10px"}} padding="0 10">{"در این صفحه می توانید از بودجه بندی آزمون ها و آخرین اخبار و اطلاعیه های سامانه آزمون مطلع شوید"}</Container> 
