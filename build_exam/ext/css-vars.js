...
__rt_setDynamic("$base-color", __rt_getGlobalDefault("$base_color") || __ColorRGBA.fromHex("#5C6BC0"), 1);
...
__rt_setDynamic("$base-highlight-color", __rt_getGlobalDefault("$base_highlight_color") || __rt_box((__rt_functions.material_color || material_color__fn).apply(__rt.functions, __rt_applySpreadArgs([
    ...
    new __Text("300", "'")]))), 4);
__rt_setDynamic("$base-dark-color", __rt_getGlobalDefault("$base_dark_color") || __ColorRGBA.fromHex("#3949AB"), 5);
