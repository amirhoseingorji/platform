...
export default class Notifs extends Component {
  ...
  state={
    reged:[],helpdialog:false,content:"",id:""
  }
  navigate = path => {
...
console.log(this.state)
    ...
    " بودجه بندی و اطلاعیه"}</h2></Container><Container hidden={Ext.platformTags.phone} style={{color:"#898989",fontSize:"10px"}} padding="0 10">{"در این صفحه می توانید از بودجه بندی آزمون ها و آخرین اخبار و اطلاعیه های سامانه آزمون مطلع شوید"}</Container> 
    ...
    <Image src={examlogo}   docked="right" width={"100px"}  height="80px"/>
       <Button  text="راهنما" cls="editinfobtn"  handler={()=>this.setState({helpdialog:true,content:""})}  textAlign="center" width="70px" style={{left:"0px", margin:"15px 0 0 0"}}   />
          <Button  text="بازگشت" cls="resentbtn ltr" handler={()=>this.navigate(id ? '/Notifs':'/')} iconCls="x-fal fa-arrow-left" textAlign="left" width="90px" iconAlign="left"  />
    </Container>
    <Button  text="بازگشت" cls="resentbtn ltr" handler={()=>this.navigate(id ? '/Notifs':'/')} iconCls="x-fal fa-arrow-left" textAlign="left" width="90px" iconAlign="left" docked="right" hidden={!Ext.platformTags.phone} />
    </Container>
    
 
                   
    <Container style={{ minHeight:Ext.platformTags.phone?"240px": "300px" }} margin="0 10" padding="5 0 0 0">
        {id ?  <Textbox title="بودجه بندی آزمونها" status={0}  description='بودجه بندی کلی آزمونها شامل اطلاعات مهمی است که در این متن برای شما قابل دسترس خواهد بود'  date={new Date()}  full={true} />:
        <Container padding="5 0 0 0">

                                   <Textbox parent={this} id='1' title="بودجه بندی آزمونها" status={0} description='بودجه بندی کلی آزمونها شامل اطلاعات مهمی است که در این متن برای شما قابل دسترس خواهد بود' date={new Date()} />
                                   <Textbox parent={this} id="2" title="آزمون آنلاین درس فلسفه و اخلاق " status={1}  description='در این قسمت توضیحات مختری در رابطه با آزمون نوشته خواهد شد '  date={new Date()} />
        </Container> }
