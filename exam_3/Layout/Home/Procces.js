...
componentWillMount() {
  ...
  phone(){
    ...
    if( this.refs.phone ) this.phoneNumber = this.refs.phone.cmp.getValue()*1; 
  ...
  Info = () =>  {
    ...
    return <Container cls={Ext.platformTags.phone?"backphone":""} padding={Ext.platformTags.phone? "0 0 0":"20"}  height="100%" width="100%" layout="center" >
