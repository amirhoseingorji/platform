...
import {  Container,  Image,  SegmentedButton,  Button,  TextField,SliderField} from '@sencha/ext-modern';
      ...
      <Container scrollable>
        ...
        {!confirm
          ? <Container cls="rtl" layout={{type:"vbox" ,align:"center"}} margin="5" ref="mainPage">
              ...
              {status=="error"?<Container style={{color:"red",backgroundColor:"#555555"}} cls="x-round"> <b>تراکنش شما با خطا مواجه شده است ، لطفا دوباره اقدام نمایید</b></Container>:null}
              {usercart.length?usercart.map ((e,i) => this.cartItemTpl (e,i)):
              
              <b>
                
                هیچ محصولی در سبد خرید شما موجود  نیست .</b>
              }
              </Container>
              <hr/>
              <Container style={{maxWidth:"800px"}}  >
                ...
                <Container {...this.rowProps}>
                  ...
                  <Container layout="center" height="45">
                    <div>{offPrice + ' تومان'}</div>
                  </Container>
                </Container>
                <Container {...this.rowProps}>
                  <b>اعتبار / موجودی شما </b>
                  <div>{ credit+ ' تومان  '}</div>
                </Container>
                <hr/>
              <Container {...this.rowProps}>
