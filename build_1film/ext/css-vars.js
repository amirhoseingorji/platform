...
__rt_setDynamic("$base-color", __rt_getGlobalDefault("$base_color") || __ColorRGBA.fromHex("#27282c"), 1);
...
__rt_setDynamic("$base-highlight-color", __rt_getGlobalDefault("$base_highlight_color") || __rt_box((__rt_functions.material_color || material_color__fn).apply(__rt.functions, __rt_applySpreadArgs([
    ...
    new __Text("300", "'")]))), 4);
__rt_setDynamic("$base-dark-color", __rt_getGlobalDefault("$base_dark_color") || __ColorRGBA.fromHex("#870000"), 5);
...
__rt_setDynamic("$accent-color", __rt_getGlobalDefault("$accent_color") || __ColorRGBA.fromHex("#f4511e"), 11);
