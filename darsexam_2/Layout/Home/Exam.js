...
<div style={{borderRadius:"10px",backgroundColor:"#ffffff",width:"99%", margin:"5px 2px 5px 0",minHeight:"500px",overflow: "hidden"}} >
  <LazyLoadImage src={"https://sitenevis.com"+e.file}     style={{ margin:"5px",padding:"0px",minHeight:"32px",minWidth:"54px" ,maxWidth:"100%"}} effect="blur" alt={"درحال بارگزاری"} wrapperClassName="place" delayTime={800} placeholderSrc={"https://azmoon.madrese.net/loading.gif"}/> 
</div>
{/*
