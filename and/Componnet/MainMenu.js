...
export default class NavMenu extends Component {
  ...
  panel = () => {
    ...
    var strTitle = '<h2 style="margin:0">اندیشکده شفافیت برای ایران</h2>';
    ...
    return (<Panel {...this.PanelProps} >
      {/* {Ext.platformTags.phone &&
        ...
        <Image src={this.state.micro?Arman:Logo} {...this.logoProps} margin="30 10 0" mode="img"  height={this.state.micro?30:70} onTap={()=>{this.props.history.push("/")}}  />
        <Container {...this.searchProps} style={{color:"#fff",fontSize:"17px"}} layout="center">
        <h3>        اندیشکده شفافیت برای ایران
      ...
      />
       ...
       ><div style={{color:"#E1F5FE",textAlign:"center",padding:"10px"}}  >
         {"          کلیه ی حقوق این سامانه متعلق به "}
         <br/>
         {" اندیشکده شفافیت برای ایران می باشد  "}
       </div>

      {/* <Image src={Logo}   {...this.ImageProps}  onTap={()=>this.navigate("/About")} />
...
//console.log(this.state.user_factor_cart)
  ...
  PanelProps = {
    ...
    height: '100%',
    cls: 'rtl mainmenu',
    style: { backgroundColor: '#26a0c1' }
  };
  footerProps = {
    docked: 'bottom',
    layout: { type: 'hbox', pack: 'center' },
    cls: 'rtl',
    style: { backgroundColor: '#1f4b90' }
  };
  ImageProps = {
    mode: 'img',
    height: '60',
  ...
  TreeListProps = {
    ...
    width: '280',
    style: { color:"#eeeeee",backgroundColor: '#26a0c1' }
  };
}
