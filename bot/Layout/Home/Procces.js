...
componentWillMount() {
  ...
  Login = () =>  {
    return  <Container padding="7"><Image src='https://tinroid.ir/images/icons/250_telegram_icon.png' mode='img' width="180" style={{margin:"auto"}} />
    <center > سامانه مدیریت ربات تلگرام  </center><br/><Container {...this.MainProps}  >
