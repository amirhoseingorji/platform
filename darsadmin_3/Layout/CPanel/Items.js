   ...
   render = () =>{
    this.config = {
        cols: {
            ...
            text: { text: "سوال", editable: true, flex: 6 },
            op1: { text: "الف", editable: true, flex: 2 },
            op2: { text: "ب", editable: true, flex: 2 },
            op3: { text: "ج", editable: true, flex: 2 },
            op4: { text: "د", editable: true, flex: 2 },
            answer: {
