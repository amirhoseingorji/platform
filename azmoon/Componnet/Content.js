    ...
    render() {
        ...
        return <Container  width="100%" {...this.props} html="">
            ...
            {ImageSrc && (typeof ImageSrc != 'string'
                ? <Carousel height="300" width="100%"  ref="album">
                    {ImageSrc.map ((e, i) => (
                    <Image height="300" src={e} mode="img" key={i} />
                    ))}
                </Carousel>
            : <Image height="300" src={ImageSrc} mode="img"  />)}
            ...
            {FileSrc && <Container layout="center" padding={3}>
                <Button  width="200" text="دانلود" conCls="x-fa a-download" cls="rtl" ui="action round" handler={this.downloader.bind(this)} />
            </Container>}
        </Container>
    }
}