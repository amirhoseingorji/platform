...
export default class User extends Component {
  ...
  render = () =>{
    ...
    <Button  text="راهنما" cls="editinfobtn"  handler={()=>this.setState({helpdialog:true,content:""})}  textAlign="center" width="70px" style={{top:"80px" ,left:"30px", margin:"0", position:"absolute" }} hidden={Ext.platformTags.phone} ui="action round" />
  ...
  {/* hidden={!e.count}  */}
                   ...
                   <Container style={{ minHeight:Ext.platformTags.phone?"240px": "300px" }} margin="0 5" padding="5 0 0 0">
                     {this.state.exam.slice(0,2).map((e,i)=> <Box key={i} parent={this} {...e}/>)}
                    
                    
                     <Container hidden={this.state.exam.length<3} layout={{ type: "hbox", align: "stretch" ,pack:"center" }} cls="x-vitrin-title" width="100%" margin="5 0 5 0">         
