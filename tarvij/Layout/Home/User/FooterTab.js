...
export default class FooterTab extends Component {
  componentWillMount() {
    ...
    Storer({user_factor_cart: {0:{_user_factor}}, footer: { from: "menu", cols: "$id as id,title as text,iconCls", 0:{_user_type:"{in('*',"+window.userData._user_type+")}", $id: "{!='/'}" , $pid: "{is null}",menu:1 },order:"ord",asc:true } }, this);
  }
  componentDidMount(){
