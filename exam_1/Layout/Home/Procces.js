          ...
          <TextField ref="class_name" validateOnInit="all" {...this.TProps} label="نام کلاس"  value={user_info.class_name}   inputMask= 'اااااااااااااااااا'/>
            ...
            handler={step == this.maxstep - 1 ? ()=>{
              ...
              Ext.Msg.confirm("اخطار",msg,(st)=>{if(st=="yes") {
                ...
                setTimeout(()=>window.socket.emit('refresh'),500)
              } });
...
onIndicatorTap = (indicator, dot) => {
  ...
  Transactions = () => {
    ...
    <Grid layout="fit" height="99%" rowNumbers store={this.state.user_transactionStore}    plugins={{ gridpagingtoolbar: false, gridsummaryrow: true          }} >
