...
<Button text="چاپ"  ui="action round" cls="greenback" height="35" handler={()=>{
    ...
    mywindow.document.write("<link href='https://sabtenam.andishmand.ir/ext/ext.css' rel='stylesheet'><style>@font-face {font-family: 'Yekan';src:  url('https://platform.ravinoserver.ir/fonts/IRANSansWeb.woff') format('woff') } body{font-family: 'Yekan'}</style></head>");
